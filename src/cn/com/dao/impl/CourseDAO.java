...
public class CourseDAO extends HibernateDaoSupport {
	...
	// property constants
	public static final String KEEPSECRET = "keepsecret";
	public static final String COURSE_NAME = "courseName";
	public static final String VIDEO_PLACE = "videoPlace";
	public static final String BOOK_PLACE = "bookPlace";
	...
	public List findByKeepsecret(Object keepsecret) {
		return findByProperty(KEEPSECRET, keepsecret);
	}
	...
	public List findByVideoPlace(Object videoPlace) {
		return findByProperty(VIDEO_PLACE, videoPlace);
	}

	public List findByBookPlace(Object bookPlace) {
		return findByProperty(BOOK_PLACE, bookPlace);
	}
