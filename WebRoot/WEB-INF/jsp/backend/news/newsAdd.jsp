...
$("#submit").click(function(){
	...
	var noticeId = "${notice.noticId}";
	var noticeTitle = $("#noticeTitle").val();
	var noticeType = $("#noticeType").val();
	var weight = $("#weight").val();
	var noticeContent = UE.getEditor('editor').getContent();
	var dataInfo = "notice.noticeTitle="+ noticeTitle + "&notice.noticeId=" + noticeId + "&notice.noticetype.noticeTypeId="+ noticeType + "&notice.weight=" + weight +"&notice.noticeContent="+ noticeContent;
	
	$.ajax({
		
		type:'post',
		url:'${basePath}admin/addNotice.action',
		data:dataInfo,
  ...
  <div class="container-fluid">
	<div class="row-fluid">
		<div id="content" class="span10">
            ...
            <font font="red" class="hide" id="name">*必须选择</font>
           </div>
           <div class="row">             
			 消息类型：			 
