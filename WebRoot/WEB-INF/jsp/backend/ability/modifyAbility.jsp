...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#addAbility").click(function(){
			...
			var dataInfo = "ability.abilityId=${ability.abilityId}&ability.abilityName=" + abilityName + "&ability.abilityURL=" + abilityURL + "&ability.abilityLevel=" + abilityLevel;
			...
			$.ajax({
				...
				type:"post",
				data:dataInfo,
				url:"${basePath}admin/modifyAbility.action",
				success:function(){
...
<div class="row-fluid">
		...
		<div class="row-fluid line-margin">
			...
			<input type="text" class=" span2" placeholder="请输入内容" name="ability.abilityName"  id="abilityName" value="${ability.abilityName}"/>
		</div>
		<div class="row-fluid line-margin">
			<span class="help-inline">权限URL：</span>
			<input type="text" class=" span2" placeholder="请输入内容" name="ability.abilityName"   id = "abilityURL" value="${ability.abilityURL}"/>
		</div>
		<div class="row-fluid line-margin">
