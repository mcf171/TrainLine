...
$(document).ready(function ()
{
	...
	mmGirdTable = $('#grid').mmGrid({
		url: '${basePath}admin/getBackendDongTaiResource.action',
		height: 410,
		autoLoad: true,
		fullWidthRows: true,
		root:'list',
		cols: [
				{ title: '动态图片名称', sortable: true,  name: 'resourceName' },
				{ title: '动态图片位置', sortable: true, name: 'resourcePath' },
...
//]]>
            ...
            <div class="row-fluid">
            	<div class="span12">
            		...
            		<div class="span12">
						<button class="btn" onclick="loadHTML('${basePath}admin/getAddResourcePage.action?resource.resourceType=3')"><i class="icon-plus"></i>&nbsp;添加</button>
					</div>			
