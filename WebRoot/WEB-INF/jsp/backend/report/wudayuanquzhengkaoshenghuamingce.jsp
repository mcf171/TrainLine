...
<!-- <div class="row-fluid line-margin">
	<div class="span12">
		<img src="report/wudayuanquzhengkaoshenghuamingce.png" usemap="#Map2"/>
	</div>
</div> -->
...
$(document).ready(function ()
{
	$('#grid').mmGrid({
		...
		cols: [
			...
			{ title: '档案编号', sortable: true, width: 145, name: '' },
			{ title: '姓名', sortable: true, width: 120, name: '' },
			{ title: '性别', sortable: true, width: 120, name: '' },
			{ title: '身份证号码', sortable: true, width: 180, name: '' },
			{ title: '学历', sortable: true, width: 120, name: '' }
		],
		plugins: [
			$('#page').mmPaginator({})
		]
