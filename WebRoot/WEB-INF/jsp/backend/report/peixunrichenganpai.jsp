...
<!-- <div class="row-fluid line-margin">
	<div class="span12">
		<img src="report/peixunrichenganpai.png" usemap="#Map2"/>
	</div>
</div> -->
...
$(document).ready(function ()
{
	$('#grid').mmGrid({
		...
		cols: [
			...
			{ title: '年度', sortable: true, width: 120, name: '' },
			{ title: '月份', sortable: true, width: 120, name: '' },
			{ title: '培训班名称', sortable: true, width: 170, name: '' },
			{ title: '培训机构', sortable: true, width: 170, name: '' },
			{ title: '日程1', sortable: true, width: 110, name: '' }
		],
		plugins: [
			$('#page').mmPaginator({})
		]
