	...
	mmGirdTable = $('#grid').mmGrid({
		...
		cols: [
				...
				{ title: '图书编号', sortable: true, name: 'bookClassIndex' },
				{
					...
					renderer: function (val, item, row)
					{
						onclick="loadHTML('${basePath}addBookPage.action?book.bookState=2')";
...
//]]>
            ...
            <div class="row-fluid">
            	<div class="span12">
            		...
            		<div class="span12">
						<button class="btn" onclick="loadHTML('${basePath}addBookPage.action?book.bookState=2')"><i class="icon-plus"></i>&nbsp;新增</button>
					</div>			
