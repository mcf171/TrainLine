...
<div class="row-fluid">
		...
		<div class="row-fluid line-margin">
			...
			<input type="text" class=" span2" placeholder="请输入内容" name="user.userName" id="roleName" />
...
$(document).ready(function ()
{
	...
	$("#finish").click(function(){
		...
		dataInfo += "role.roleName=" + roleName + abilityIds;
		
		$.ajax({
			
			type:"post",
			data:dataInfo,
			url:"${basePath}admin/addRole.action",
			success:function(){
