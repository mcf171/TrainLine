...
<div class="row-fluid">
	<form action="modifyCompany.action"  enctype="multipart/form-data" method="post">
		...
		<div class="row-fluid line-margin">
			...
			<select class="input-small " name="company.companystatus" value="${company.companystatus}">
				<option>0</option>
				<option>1</option>
				<option>2</option>
				<option>3</option>
		...
		<div class="row-fluid line-margin">
			...
			<textarea class=" span2" placeholder="请输入内容" name="company.companyIntro" value="${company.companyIntro}"/>
		</div>
		<div class="row-fluid line-margin">
