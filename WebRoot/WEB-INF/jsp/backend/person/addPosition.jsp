...
$(document).ready(function(){
	...
	$("#submit").click(function(){
		...
		var dataInfo = "position.positionName=" + positionName + "&position.department.departmentId=" + departmentName + selectCourseId; 
		...
		if(flag){
			...
			$.ajax({
				...
				type:"post",
				url:"${admin}admin/addPosition.action",
				data:dataInfo,
...
function getDepartmentNameByCompanyId() {
	...
	$("#departmentName").find("option").remove();
		$.ajax({
				 url : '${admin}admin/getDepartmentList.action',
...
<div class="row-fluid">
		<div class="row-fluid line-margin">
			...
			<input type="text" class=" span2" placeholder="请输入职位名称" name="position.positionName"  id="positionName"/>
		</div>
		<div class="row-fluid line-margin">
		...
		<div class="row-fluid line-margin">
			<button class="btn span1" type="submit"  id="submit">
				确定
			</button>
