...
<script type="text/javascript">
	...
	$("#addPeroson").click(function addPeroson(){
		...
		dataInfo = "user.userName="+userName+"&user.userPassword=" + userPassword + "&user.personalinformation.realName=" + realName + "&user.personalinformation.sex=" + sex +"&user.userState=" + userState + positionIds + roleIds;
