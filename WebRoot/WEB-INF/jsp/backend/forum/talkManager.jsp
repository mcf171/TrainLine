...
$(document).ready(function ()
{
	...
	mmGirdTable = $('#grid').mmGrid({
		...
		root:'liberary',
		cols: [
				{ title: '帖子名称', sortable: true,  name: 'themeName' },
				{ title: '帖子编号', sortable: true, name: 'themeId' },
				{ title: '帖子时间', sortable: true, name: 'themeId' },
				{ title: '帖子内容', sortable: true, name: 'themeId' },
				{ title: '帖子用户', sortable: true, name: 'themeId' },
				{ title: '主题名称', sortable: true, name: 'themeId' },
				{
					title: '操作',
					width: 100,
