...
$(document).ready(function ()
{
	...
	$('#grid').mmGrid({
		...
		fullWithRows: true,
		cols: [
			{ title: '话题名称', sortable: true, width: 100, name: 'topicName' },	
			{ title: '话题编号', sortable: true, width: 100, name: 'course' },
			{ title: '所属主题名称', sortable: true, width: 100, name: 'course' },
			{ title: '用户名称', sortable: true, width: 100, name: 'course' },
			{ title: '用户名称', sortable: true, width: 100, name: 'course' },
			{ title: '主题图片路径', sortable: true, width: 100, name: '' },
						{
				title: '操作',
				width: 280,
