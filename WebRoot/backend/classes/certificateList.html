...
<div class="container-fluid">
	...
	<div id="content" class="span10">
               ...
               <button class="btn" type="button"><i class="icon-plus"></i>添加</button>  
               <button class="btn" type="button" onclick="loadHTML('classes/certificate.html')"><i class="icon-arrow-up"></i>批量导入</button>                  
             </div>
