    ...
    MMPaginator.prototype = {
        ...
        , _plain: function(page, totalCount, limit){
            ...
            if(page<=1){
                ...
                $prev.on('click', prevPage).find('a').on('click', prevPage);
            }
            ...
            $.each(list, function(index, item){
                ...
                if(item === '...'){
                    ...
                    $li.on('click', gotoPage).find('a').text(item).prop('title','第'+item+'页').on('click', gotoPage);
                }
                $pageList.append($li);
            });
            //
            ...
            if(page>=totalPage){
                ...
                $next.on('click', nextPage).find('a').on('click', nextPage);
            }
